style_list = [
    {
        ...
        {
        "name": "Anime",
        "prompt": "anime cartoon style business person, dressed very nicely and professional, (highly detailed:1.0), {prompt}",
        "negative_prompt": "hyper realism, ugly, fat, deformed, crossed eyes, low quality, (worst quality:1.4), text, signature, watermark, extra limbs, over saturated",
    },
        {
        "name": "Studio Ghibli",
        "prompt": "Studio Ghibli style, magical, enchanting, serene landscapes, detailed backgrounds, vivid colors, {prompt}, traditional animation, hand-drawn, flying scenes, nature, environmental, whimsical creatures, elaborate costumes, strong characters",
        "negative_prompt": "hyper realism, monochrome, low quality, (worst quality:1.4), watermark, text, extra limbs, deformed, oversaturated, photo realistic, 3D models, gritty, dark themes, disturbing, violence",
    },
    {
        "name": "Watercolor",
